...
confs:
	@ sudo mkdir -p /home/ada-cruz/data/db_data
	@ sudo mkdir -p /home/ada-cruz/data/wp_data
	@ sudo grep "ada-cruz.42.fr" /etc/hosts || sudo sh -c 'echo "127.0.0.1 ada-cruz.42.fr" >> /etc/hosts'
